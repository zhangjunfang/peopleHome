...
public class PageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (id.endsWith("ByPage"))// 以ByPage作结尾
		{
			...
			Page page = ThreadLocalUtil.current();
			...
			if (page != null) {
				...
				sb.append(String
						.format("select alias.* from (select tmp.* ,rownum from (%s) tmp) alias where  rownum between %s and %s",
								originalSql, offset, page.getPageSize()));
	...
	private MappedStatement copyFromMappedStatement(MappedStatement ms,
		...
		// builder.key(ms.getKeyProperties());
