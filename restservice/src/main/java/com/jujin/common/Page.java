...
public class Page {
  ...
  private Page() {
    ...
    totalRecord = 0;
    totalPage = 0;
    params =new HashMap<String, String>();  //Maps.newHashMap();
    paramLists =new HashMap<String, List<String>>(); //Maps.newHashMap();
    searchUrl = "";
    pageNoDisp = "";
  }
...
&nbsp;&nbsp; *&nbsp;&nbsp; 1,2..6,7,8,9,10,11,12,[13]
  ...
  private String computeDisplayStyleAndPage(){
    List<Integer> pageDisplays =new ArrayList<Integer>(); //Lists.newArrayList();
    if ( totalPage <= 11 ){
