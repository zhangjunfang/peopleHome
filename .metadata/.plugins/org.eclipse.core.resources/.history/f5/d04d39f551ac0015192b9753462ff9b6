...
import com.ocean.common.exception.JsonException;
import com.ocean.common.util.Strings;
...
public class Jsons {
     ...
     * @return json string
     * @throws com.ocean.common.exception.JsonException the exception for json
     */
