 ...
 *
 */
public interface RestAuthentication extends Serializable ,Ordered {
	 ...
	 * @param uri     uri就是HttpServletRequest.getRequestURI()的值
	 * @return  true表示允许  false表示不允许
	 */
	
	boolean isAuthentication(Object object,String uri);
